...
namespace MineSnake
{
	public partial class Level10 : Form
	{
		...
		private void Level10_Load(object sender, EventArgs e)
		{
			...
			// Start of the game
			List<int> obstacleX = new List<int>() { 2, 7, 1, 6, 12, 12 };
			List<int> obstacleY = new List<int>() { 1, 5, 10, 7, 2, 3 };
			game.prepare(13, 13, 5, 0, 3, obstacleX, obstacleY, 20, 22, pBoxes, visited);
			game.repaint();
			game.play(1000);
		}
