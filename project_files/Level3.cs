...
namespace MineSnake
{
	public partial class Level3 : Form
	{
        ...
        public Level3(string name, Form1 f)
        {
            InitializeComponent();
            this.name = name;
        }
            ...
            private void Level3_Load(object sender, EventArgs e)
		{
			...
			List<int> obstacleX = new List<int>() { 5, 7 };
			List<int> obstacleY = new List<int>() { 5, 5 };
			game.prepare(10, 10, 3, 0, 3, obstacleX, obstacleY, 13, 16, pBoxes, visited);
			game.repaint();
			game.play(1000);
		}
