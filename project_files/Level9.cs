...
namespace MineSnake
{
	public partial class Level9 : Form
	{
		...
		public Level9(string name, Form1 f)
		{
			InitializeComponent();
			this.name = name;
			form = f;
		...
		private void Level9_Load(object sender, EventArgs e)
		{
			label3.Text = name;
			...
			// Start of the game
			List<int> obstacleX = new List<int>() { 2, 7, 11 };
			List<int> obstacleY = new List<int>() { 1, 5, 11 };
			game.prepare(13, 13, 4, 0, 3, obstacleX, obstacleY, 18, 18, pBoxes, visited);
			game.repaint();
			game.play(1000);
		}
        ...
        private void Level9_FormClosed(object sender, FormClosedEventArgs e)
        {
			form.Show();
		}
    }
